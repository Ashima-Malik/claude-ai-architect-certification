...
# The below line in while loop, changes the architecture completely, In one tool, one loop, call claude -> execute tool -> call claude one more time
# But, here, number of iterations are not hardcoded, it will run until as long as claude is asking for it. 
